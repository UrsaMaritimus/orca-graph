...
export class Orca__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class Orca extends ethereum.SmartContract {
  static bind(address: Address): Orca {
    return new Orca("Orca", address);
  }
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): Orca__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return result[0].toTuple() as Orca__checkpointsResultValue0Struct;
  }

  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<Orca__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as Orca__checkpointsResultValue0Struct
    );
  }
