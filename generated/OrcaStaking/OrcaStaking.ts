...
export class OrcaStaking__poolInfoResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class OrcaStaking__userInfoResult {
  value0: BigInt;
  value1: BigInt;
...
export class OrcaStaking extends ethereum.SmartContract {
  static bind(address: Address): OrcaStaking {
    return new OrcaStaking("OrcaStaking", address);
  }
  ...
  poolInfo(param0: BigInt): OrcaStaking__poolInfoResult {
    let result = super.call(
      "poolInfo",
    ...
    return new OrcaStaking__poolInfoResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_poolInfo(
    param0: BigInt
  ): ethereum.CallResult<OrcaStaking__poolInfoResult> {
    let result = super.tryCall(
      "poolInfo",
      "poolInfo(uint256):(address,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new OrcaStaking__poolInfoResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  userInfo(param0: BigInt, param1: Address): OrcaStaking__userInfoResult {
    let result = super.call(
      "userInfo",
    ...
    return new OrcaStaking__userInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_userInfo(
    param0: BigInt,
    param1: Address
  ): ethereum.CallResult<OrcaStaking__userInfoResult> {
    let result = super.tryCall(
      "userInfo",
      "userInfo(uint256,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new OrcaStaking__userInfoResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
}
